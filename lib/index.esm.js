...
function PopoverContent({ countries, isOpen, width, onChangeSearch, value, }) {
    ...
    return (React__default.createElement("div", { className: "eteg-flex eteg-flex-col" },
        ...
        countries.map((country) => (React__default.createElement(Button, { variant: "ghost", key: country.pais, className: "eteg-text-foreground eteg-justify-start", size: "sm" },
...
const InputPhone = React__default.forwardRef(({ value = "55", onChangeValue, error, label = "Telefone", ...props }, ref) => {
    ...
    return (React__default.createElement("div", { "data-error": !!error, ref: divRef, className: "twp eteg-flex eteg-flex-col eteg-gap-3" },
        React__default.createElement(Label, { "aria-required": props.required }, label),
        React__default.createElement("div", { className: "eteg-relative" },
            React__default.createElement(Popover.Root, { onOpenChange: setPopoverIsOpen, open: popoverIsOpen },
                React__default.createElement(Popover.Trigger, { asChild: true },
                    React__default.createElement(Button, { variant: "ghost", disabled: props.disabled, className: "eteg-flex eteg-gap-1 eteg-absolute eteg-border-r eteg-rounded-none eteg-border-r-input eteg-z-10" },
                ...
                React__default.createElement(Popover.Content, { id: "popover", align: "start", className: "eteg-p-0" },
                    React__default.createElement(PopoverContent, { countries: mostrarItens, width: divWidth, isOpen: popoverIsOpen, onChangeSearch: (text) => setSearch(text), value: search }))),
            React__default.createElement(InputText, { type: "tel", value: phoneMask(phoneNumber, selectedCountry), onChange: (e) => onChangeInput(e.target.value, selectedCountry), name: "Pais", inputClassName: "eteg-pl-20", ...props, ref: ref })),
        error && React__default.createElement("span", null, error)));
});
