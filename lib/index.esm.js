...
const SelectSearchContent = ({ buttonRef, children, emptyMessage, inputPlaceholder, onSelect, }) => {
    ...
    return (React__default.createElement(Popover.Content, { style: { width: `${width}px` }, className: "eteg-p-0 twp eteg-border-input" },
        React__default.createElement(Command.Root, null,
            React__default.createElement(InputText, { icon: FiSearch, inputClassName: "eteg-border-x-transparent eteg-rounded-none eteg-border-t-transparent", placeholder: inputPlaceholder }),
...
function SelectSearchRoot({ children, trigger }) {
    ...
    return (React__default.createElement(Popover.Root, { open: open, onOpenChange: setOpen },
        React__default.createElement(Popover.Trigger, { asChild: true },
            React__default.createElement(Button, { variant: "outline", role: "combobox", "aria-expanded": open, className: "eteg-w-full eteg-justify-between twp eteg-border-input eteg-text-secondary", ref: buttonRef },
                trigger,
                React__default.createElement(FiChevronDown, { className: "eteg-ml-2 eteg-h-4 eteg-w-4 eteg-shrink-0 eteg-opacity-50" }))),
        React__default.createElement(SelectSearchContent, { buttonRef: buttonRef, onSelect: () => {
                setOpen(false);
            } }, children)));
}
const SelectSearch = {
