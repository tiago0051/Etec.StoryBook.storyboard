...
const Label = React.forwardRef(({ className, children, ...props }, ref) => (React.createElement($b73a6c6685e72184$export$be92b6f5f03c0fe9, { ref: ref, className: cn(labelVariants(), "peer-required:[&>span]:eteg-visible", className), ...props },
    children,
    " ",
    React.createElement("span", { className: "eteg-text-xl eteg-font-bold eteg-text-destructive eteg-leading-3 hidden" }, "*"))));
...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (React.createElement("td", { ref: ref, className: cn("eteg-py-6 eteg-text-sm eteg-text-foreground/80 [&:last-child]:eteg-pr-0 eteg-align-middle eteg-pr-4", className), ...props })));
...
export { Badge, Button, Header, InputFile, InputText, Label, Pagination, Select, Skeleton, Table, badgeVariants };
