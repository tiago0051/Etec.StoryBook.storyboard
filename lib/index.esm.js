...
const DialogTitle = React.forwardRef(({ className, ...props }, ref) => (React.createElement($5d3850c4d0b4e6c7$export$f99233281efd08a0, { ref: ref, className: cn("eteg-text-xl eteg-font-semibold eteg-leading-none eteg-tracking-tight eteg-text-foreground", className), ...props })));
