...
const Label = React.forwardRef(({ className, children, ...props }, ref) => (React.createElement($b73a6c6685e72184$export$be92b6f5f03c0fe9, { ref: ref, className: cn(labelVariants(), className), ...props },
    children,
    " ",
    React.createElement("span", { className: "eteg-text-xl eteg-font-bold eteg-text-destructive eteg-leading-3 eteg-hidden aria-required:eteg-inline", "aria-required": props["aria-required"] }, "*"))));
