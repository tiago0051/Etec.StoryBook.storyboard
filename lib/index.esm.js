...
const AlertDialogFooter = ({ className, ...props }) => (React.createElement("div", { className: cn("eteg-flex eteg-flex-col-reverse sm:eteg-flex-row sm:eteg-justify-end sm:eteg-space-x-2", className), ...props }));
...
export { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogOverlay, AlertDialogPortal, AlertDialogTitle, AlertDialogTrigger, Badge, Button, Combobox, Dialog, Header, InputFile, InputText, Label, Pagination, Select, Separator, Skeleton, Table, badgeVariants };
