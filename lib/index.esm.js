    ...
    return (React__default.createElement(Popover.Content, { style: { width: `${width}px` }, className: "eteg-p-0 twp eteg-border-input" },
        React__default.createElement(Command.Root, null,
            ...
            React__default.createElement(Command.List, null,
                React__default.createElement(Command.Group, null, React__default.Children.map(children, (child, index) => (React__default.createElement(Command.Item, { onSelect: () => onSelect(index), className: "eteg-h-12 eteg-px-2" }, child))))))));
};
SelectSearchContent.displayName = "SelectSearchContent";
const SelectSearchSkeletonItem = () => (React__default.createElement(Skeleton, { className: "eteg-h-5 eteg-w-full" }));
...
function SelectSearchRoot({ children, onChange, onSelect, trigger, value, className, disabled = false, emptyMessage, error, inputPlaceholder, label, required = false, }) {
    ...
    return (React__default.createElement("div", { className: cn("eteg-relative twp", className) },
        ...
        React__default.createElement(Popover.Root, { open: open, onOpenChange: setOpen },
            ...
            React__default.createElement(SelectSearchContent, { buttonRef: buttonRef, value: value, onChange: onChange, onSelect: (index) => {
                    setOpen(false);
                    onSelect(index);
