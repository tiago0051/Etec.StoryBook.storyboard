...
import React__default, { useCallback, forwardRef, Children, isValidElement, createElement, cloneElement, Fragment, useEffect, useRef, createContext, useMemo, useContext, useState, useLayoutEffect } from 'react';
...
function Header({ children, onBackClick, subtitle, title, }) {
    return (React__default.createElement("div", { className: "twp" },
        onBackClick && (React__default.createElement(Button, { variant: "link", size: "none", type: "button", className: "eteg-flex eteg-gap-3 eteg-text-foreground/60 eteg-hover:text-foreground eteg-mb-5", onClick: () => onBackClick() },
        ...
        React__default.createElement("div", { className: "eteg-flex eteg-flex-col sm:eteg-flex-row sm:eteg-justify-between sm:eteg-items-center eteg-gap-4" },
            React__default.createElement("div", null,
                React__default.createElement("h1", { className: "eteg-font-lato eteg-font-semibold eteg-text-3xl eteg-text-foreground eteg-mb-1" }, title),
                React__default.createElement("p", { className: "eteg-font-lato eteg-font-semibold eteg-text-base eteg-text-foreground/60" }, subtitle)),
...
const Label = React.forwardRef(({ className, ...props }, ref) => (React.createElement($b73a6c6685e72184$export$be92b6f5f03c0fe9, { ref: ref, className: cn(labelVariants(), className), ...props })));
...
function InputFile({ valueText, label, error, onRemove, className, icon: Icon, ...props }) {
    ...
    return (React__default.createElement("div", { className: "eteg-relative twp" },
        label && (React__default.createElement(Label, { "data-error": !!error, htmlFor: props.name, className: "block mb-3" },
            label,
            " ",
        ...
        error && (React__default.createElement("span", { className: "eteg-absolute eteg--bottom-5 eteg-text-xs eteg-text-destructive" }, error))));
}

const InputText = React.forwardRef(({ className, type, label, error, ...props }, ref) => {
...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (React.createElement("thead", { ref: ref, className: cn("[&_tr]:eteg-border-b [&_tr]:eteg-border-b-input [&_tr]:eteg-border-t-transparent", className), ...props })));
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (React.createElement("tr", { ref: ref, className: cn("eteg-transition-colors data-[state=selected]:eteg-bg-muted eteg-border-t-input eteg-border-t", className), ...props })));
TableRow.displayName = "TableRow";
const TableRowDropDown = React.forwardRef(({ className, isOpen, ...props }, ref) => (React.createElement(Table.Row, { className: "eteg-border-t-0" },
    React.createElement(Table.Cell, { colSpan: 4, className: "eteg-py-0" },
...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (React.createElement("td", { ref: ref, className: cn("eteg-py-6 eteg-text-sm eteg-text-foreground/80 [&:first-child]:eteg-pl-0 [&:last-child]:eteg-pr-0 eteg-align-middle eteg-px-4", className), ...props })));
...
export { Button, Header, InputFile, InputText, Label, Pagination, Select, Skeleton, Table };
