...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (React.createElement("td", { ref: ref, className: cn("eteg-py-6 eteg-text-sm eteg-font-lato eteg-text-foreground/85 [&:last-child]:eteg-pr-0 eteg-align-middle eteg-pr-4", className), ...props })));
...
const PopoverContent = React.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => (React.createElement($cb5cc270b50c6fcd$export$602eac185826482c, null,
...
function ComboboxRoot({ children, ...props }) {
    ...
    return (React.createElement("div", { className: "twp" },
        React.createElement(Popover, { open: open, onOpenChange: setOpen },
            React.createElement(PopoverTrigger, { asChild: true, onClick: (e) => e.preventDefault() },
            ...
            React.createElement(PopoverContent, { className: "p-0 popover eteg-box-border", id: "popover", onOpenAutoFocus: (e) => e.preventDefault() },
...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (React.createElement(DialogPortal, null,
    ...
    React.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, { ref: ref, className: cn("eteg-fixed eteg-left-[50%] eteg-top-[50%] eteg-z-50 eteg-grid eteg-w-full eteg-max-w-lg eteg-translate-x-[-50%] eteg-translate-y-[-50%] eteg-gap-4 eteg-border eteg-bg-background eteg-p-6 eteg-shadow-lg eteg-duration-200 data-[state=open]:eteg-animate-in data-[state=closed]:eteg-animate-out data-[state=closed]:eteg-fade-out-0 data-[state=open]:eteg-fade-in-0 data-[state=closed]:eteg-zoom-out-95 data-[state=open]:eteg-zoom-in-95 data-[state=closed]:eteg-slide-out-to-left-1/2 data-[state=closed]:eteg-slide-out-to-top-[48%] data-[state=open]:eteg-slide-in-from-left-1/2 data-[state=open]:eteg-slide-in-from-top-[48%] sm:eteg-rounded-lg twp", className), ...props },
        ...
        React.createElement($5d3850c4d0b4e6c7$export$f39c2d165cd861fe, { className: "eteg-absolute eteg-right-4 eteg-top-4 eteg-rounded-sm eteg-ring-offset-background focus:eteg-outline-none disabled:eteg-pointer-events-none data-[state=open]:eteg-bg-accent data-[state=open]:eteg-text-muted-foreground hover:eteg-text-destructive twp" },
            React.createElement(FiX, { className: "eteg-h-4 eteg-w-4" }),
...
const DialogFooter = ({ className, ...props }) => (React.createElement("div", { className: cn("eteg-flex eteg-flex-col-reverse sm:eteg-flex-row sm:eteg-justify-end sm:eteg-space-x-2 twp", className), ...props }));
DialogFooter.displayName = "DialogFooter";
const DialogTitle = React.forwardRef(({ className, ...props }, ref) => (React.createElement($5d3850c4d0b4e6c7$export$f99233281efd08a0, { ref: ref, className: cn("eteg-text-lg eteg-font-semibold eteg-leading-none eteg-tracking-tight", className), ...props })));
DialogTitle.displayName = $5d3850c4d0b4e6c7$export$f99233281efd08a0.displayName;
const DialogDescription = React.forwardRef(({ className, ...props }, ref) => (React.createElement($5d3850c4d0b4e6c7$export$393edc798c47379d, { ref: ref, className: cn("eteg-text-sm eteg-text-muted-foreground", className), ...props })));
...
export { Badge, Button, Combobox, Dialog, Header, InputFile, InputText, Label, Pagination, Select, Separator, Skeleton, Table, badgeVariants };
