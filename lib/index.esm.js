...
const Label = React.forwardRef(({ className, children, ...props }, ref) => (React.createElement($b73a6c6685e72184$export$be92b6f5f03c0fe9, { ref: ref, className: cn(labelVariants(), className), ...props },
    children,
    React.createElement("span", { className: "eteg-text-xl eteg-font-bold eteg-text-destructive eteg-absolute eteg-hidden aria-required:eteg-inline -eteg-top-3 eteg-px-1", "aria-required": props["aria-required"] }, "*"))));
...
export { AlertDialog, Badge, Button, Checkbox, Combobox, Dialog, Header, InputFile, InputText, Label, Pagination, Select, Separator, Skeleton, Table, badgeVariants };
