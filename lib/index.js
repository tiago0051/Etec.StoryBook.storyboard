...
const SelectSearchContent = ({ buttonRef, children, emptyMessage, inputPlaceholder, onSelect, }) => {
    ...
    return (React.createElement(Popover.Content, { style: { width: `${width}px` }, className: "eteg-p-0 twp eteg-border-input" },
        React.createElement(Command.Root, null,
            React.createElement(InputText, { icon: FiSearch, inputClassName: "eteg-border-x-transparent eteg-rounded-none eteg-border-t-transparent", placeholder: inputPlaceholder }),
...
function SelectSearchRoot({ children, trigger }) {
    const buttonRef = React.useRef(null);
    const [open, setOpen] = React.useState(false);
    return (React.createElement(Popover.Root, { open: open, onOpenChange: setOpen },
        React.createElement(Popover.Trigger, { asChild: true },
            React.createElement(Button, { variant: "outline", role: "combobox", "aria-expanded": open, className: "eteg-w-full eteg-justify-between twp eteg-border-input eteg-text-secondary", ref: buttonRef },
                trigger,
                React.createElement(FiChevronDown, { className: "eteg-ml-2 eteg-h-4 eteg-w-4 eteg-shrink-0 eteg-opacity-50" }))),
        React.createElement(SelectSearchContent, { buttonRef: buttonRef, onSelect: () => {
                setOpen(false);
            } }, children)));
}
const SelectSearch = {
