...
const labelVariants = cva("eteg-text-sm eteg-font-medium eteg-leading-none eteg-peer-disabled:cursor-not-allowed eteg-peer-disabled:opacity-70 eteg-font-lato eteg-text-border data-[error=true]:eteg-text-destructive");
const Label = React__namespace.forwardRef(({ className, children, ...props }, ref) => (React__namespace.createElement($b73a6c6685e72184$export$be92b6f5f03c0fe9, { ref: ref, className: cn(labelVariants(), className), ...props },
    children,
    " ",
    React__namespace.createElement("span", { className: "eteg-text-xl eteg-font-bold eteg-text-destructive eteg-leading-3 eteg-hidden aria-required:eteg-inline", "aria-required": props["aria-required"] }, "*"))));
