...
const DialogContent = React__namespace.forwardRef(({ className, children, ...props }, ref) => (React__namespace.createElement(DialogPortal, null,
    ...
    React__namespace.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, { ref: ref, className: cn("eteg-fixed eteg-left-[50%] eteg-top-[50%] eteg-z-50 eteg-grid eteg-w-full eteg-max-w-lg eteg-translate-x-[-50%] eteg-translate-y-[-50%] eteg-gap-4 eteg-border eteg-bg-background eteg-p-6 eteg-shadow-lg eteg-duration-200 data-[state=open]:eteg-animate-in data-[state=closed]:eteg-animate-out data-[state=closed]:eteg-fade-out-0 data-[state=open]:eteg-fade-in-0 data-[state=closed]:eteg-zoom-out-95 data-[state=open]:eteg-zoom-in-95 data-[state=closed]:eteg-slide-out-to-left-1/2 data-[state=closed]:eteg-slide-out-to-top-[48%] data-[state=open]:eteg-slide-in-from-left-1/2 data-[state=open]:eteg-slide-in-from-top-[48%] sm:eteg-rounded-lg twp", className), ...props },
        ...
        React__namespace.createElement($5d3850c4d0b4e6c7$export$f39c2d165cd861fe, { className: "eteg-absolute eteg-right-4 eteg-top-4 eteg-rounded-sm eteg-ring-offset-background focus:eteg-outline-none disabled:eteg-pointer-events-none data-[state=open]:eteg-bg-accent data-[state=open]:eteg-text-muted-foreground hover:eteg-text-destructive twp" },
            React__namespace.createElement(FiX, { className: "eteg-h-4 eteg-w-4" }),
...
const DialogTitle = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($5d3850c4d0b4e6c7$export$f99233281efd08a0, { ref: ref, className: cn("eteg-text-lg eteg-font-semibold eteg-leading-none eteg-tracking-tight", className), ...props })));
