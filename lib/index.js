...
const InputText = React__namespace.forwardRef(({ className, type, label, error, ...props }, ref) => {
    return (React__namespace.createElement("div", { className: cn("eteg-relative twp", className) },
        ...
        React__namespace.createElement("input", { type: type, "data-error": !!error, className: "eteg-flex eteg-h-12 eteg-w-full eteg-rounded-md eteg-border eteg-border-input eteg-bg-transparent eteg-px-4 eteg-text-sm eteg-placeholder:text-muted-foreground eteg-disabled:cursor-not-allowed eteg-disabled:bg-muted eteg-disabled:text-muted-foreground eteg-text-foreground data-[error=true]:eteg-border-destructive", ref: ref, ...props }),
...
const TableRowDropDown = React__namespace.forwardRef(({ className, isOpen, ...props }, ref) => (React__namespace.createElement(Table.Row, { className: "eteg-border-t-0" },
    React__namespace.createElement(Table.Cell, { colSpan: 4, className: "eteg-py-0" },
        React__namespace.createElement("div", { "data-open": isOpen, className: cn("eteg-grid eteg-h-0 eteg-grid-cols-1 eteg-gap-4 eteg-overflow-hidden eteg-rounded-md eteg-bg-muted-foreground/25 eteg-px-8 eteg-py-0 eteg-transition-all data-[open=true]:eteg-h-min data-[open=true]:eteg-py-6 sm:eteg-grid-cols-2 md:eteg-grid-cols-3", className), ref: ref, ...props })))));
...
const TableCell = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("td", { ref: ref, className: cn("eteg-py-6 eteg-text-sm eteg-text-foreground/80 [&:first-child]:eteg-pl-0 [&:last-child]:eteg-pr-0 eteg-align-middle eteg-px-4", className), ...props })));
...
const PaginationLink = ({ className, isActive, ...props }) => (React__namespace.createElement("a", { "aria-current": isActive ? "page" : undefined, "data-active": !!isActive, className: cn(buttonVariants({
    ...
    }), "data-[active=true]:eteg-rounded-full eteg-w-6 eteg-h-6 data-[active=false]:eteg-text-muted-foreground eteg-text-xs eteg-font-lato eteg-p-0", className), ...props }));
