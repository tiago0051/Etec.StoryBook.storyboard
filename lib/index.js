...
const Label = React__namespace.forwardRef(({ className, children, ...props }, ref) => (React__namespace.createElement($b73a6c6685e72184$export$be92b6f5f03c0fe9, { ref: ref, className: cn(labelVariants(), "peer-required:[&>span]:eteg-visible", className), ...props },
    children,
    " ",
    React__namespace.createElement("span", { className: "eteg-text-xl eteg-font-bold eteg-text-destructive eteg-leading-3 hidden" }, "*"))));
...
const InputText = React__namespace.forwardRef(({ className, type, label, error, icon: Icon, ...props }, ref) => {
    return (React__namespace.createElement("div", { className: cn("eteg-relative twp", className) },
        label && (React__namespace.createElement(Label, { "data-error": !!error, htmlFor: props.name, className: "eteg-block eteg-mb-3" }, label)),
        React__namespace.createElement("div", { className: "eteg-relative eteg-flex eteg-items-center peer" },
