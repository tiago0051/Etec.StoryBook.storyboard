...
const DialogFooter = ({ className, ...props }) => (React__namespace.createElement("div", { className: cn("eteg-flex eteg-flex-col-reverse sm:eteg-flex-row sm:eteg-justify-end sm:eteg-space-x-2 twp", className), ...props }));
...
const AlertDialogFooter = ({ className, ...props }) => (React__namespace.createElement("div", { className: cn("eteg-flex eteg-flex-col-reverse sm:eteg-flex-row sm:eteg-justify-end sm:eteg-space-x-2", className), ...props }));
