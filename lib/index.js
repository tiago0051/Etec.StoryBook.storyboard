...
function Header({ children, onBackClick, subtitle, title, }) {
    return (React.createElement("div", { className: "twp" },
        onBackClick && (React.createElement(Button, { variant: "link", size: "none", type: "button", className: "eteg-flex eteg-gap-3 eteg-text-foreground/70 eteg-hover:text-foreground eteg-mb-4 eteg-capitalize text-base eteg-font-bold eteg-font-lato", onClick: () => onBackClick() },
            React.createElement(BsArrowLeft, { size: 16 }),
            "Voltar")),
        React.createElement("div", { className: "eteg-flex eteg-flex-col sm:eteg-flex-row sm:eteg-justify-between sm:eteg-items-center eteg-gap-4" },
            React.createElement("div", null,
                React.createElement("h1", { className: "eteg-font-lato eteg-font-semibold eteg-text-[32px] eteg-text-foreground" }, title),
                React.createElement("p", { className: "eteg-font-lato eteg-font-semibold eteg-text-sm eteg-text-foreground/65" }, subtitle)),
            children && (React.createElement("div", { className: "sm:eteg-max-w-xs eteg-w-full eteg-flex eteg-justify-end" }, children)))));
}
...
const $b73a6c6685e72184$export$b04be29aa201d4f5 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    return /*#__PURE__*/ React.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.label, _extends$1({}, props, {
        ref: forwardedRef,
        onMouseDown: (event)=>{
...
const Label = React__namespace.forwardRef(({ className, children, ...props }, ref) => (React__namespace.createElement($b73a6c6685e72184$export$be92b6f5f03c0fe9, { ref: ref, className: cn(labelVariants(), className), ...props },
    children,
    React__namespace.createElement("span", { className: "eteg-text-xl eteg-font-bold eteg-text-destructive eteg-absolute eteg-hidden aria-required:eteg-inline -eteg-top-2 eteg-px-1", "aria-required": props["aria-required"] }, "*"))));
...
function InputFile({ valueText, label, error, onRemove, className, icon: Icon, ...props }) {
    ...
    return (React.createElement("div", { className: "eteg-relative twp" },
        label && (React.createElement(Label, { "data-error": !!error, htmlFor: props.name, className: "eteg-block eteg-mb-3" },
            label,
            " ",
            props.required && (React.createElement("span", { className: "eteg-text-xl eteg-font-bold eteg-text-destructive eteg-leading-3" }, "*")))),
        React.createElement("div", { "data-disabled": props.disabled, "data-error": !!error, className: cn("eteg-h-12 eteg-border eteg-border-input eteg-grid eteg-grid-flow-col eteg-gap-3 eteg-rounded-md eteg-px-5 disabled:eteg-cursor-not-allowed data-[disabled=true]:eteg-bg-muted data-[error=true]:eteg-border-destructive", className) },
            React.createElement("button", { className: "eteg-grid eteg-grid-flow-col eteg-items-center eteg-gap-1 eteg-border-none eteg-bg-transparent eteg-text-muted-foreground", onClick: (e) => handleClickText(e), type: "button" },
                Icon && React.createElement(Icon, { size: 16 }),
                React.createElement("p", { className: "eteg-truncate eteg-text-sm eteg-font-lato" }, valueText || "Nenhum arquivo selecionado")),
            React.createElement("input", { className: "eteg-hidden eteg-peer/input", ...props, type: "file", ref: inputRef }),
            React.createElement("button", { type: "button", className: "eteg-text-sm eteg-bg-secondary eteg-h-7 eteg-rounded-md eteg-text-secondary-foreground eteg-w-32 eteg-self-center", onClick: (e) => {
                    if (valueText) {
                        e.preventDefault();
...
const InputText = React__namespace.forwardRef(({ className, type, label, error, icon: Icon, inputClassName, ...props }, ref) => {
    return (React__namespace.createElement("div", { className: cn("eteg-relative twp", className) },
        label && (React__namespace.createElement(Label, { "data-error": !!error, htmlFor: props.name, className: "eteg-block eteg-mb-3 peer", "aria-required": !!props.required }, label)),
        React__namespace.createElement("div", { className: "eteg-relative eteg-flex eteg-items-center" },
            Icon && (React__namespace.createElement(Icon, { size: 18, className: "eteg-absolute eteg-left-4 eteg-text-muted-foreground" })),
            React__namespace.createElement("input", { type: type, "data-error": !!error, "data-icon": !!Icon, className: cn("eteg-flex eteg-h-12 eteg-w-full eteg-rounded-md eteg-border eteg-border-input eteg-bg-transparent eteg-px-4 eteg-text-sm placeholder:text-muted-foreground disabled:eteg-cursor-not-allowed disabled:eteg-bg-muted disabled:eteg-text-muted-foreground eteg-text-foreground data-[error=true]:eteg-border-destructive data-[icon=true]:eteg-pl-12 focus:eteg-outline-none", inputClassName), ref: ref, ...props })),
        error && (React__namespace.createElement("span", { className: "eteg-absolute -eteg-bottom-[18px] eteg-text-xs eteg-text-destructive" }, error))));
});
InputText.displayName = "InputText";

/* eslint-disable react-refresh/only-export-components */
const TableRoot = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("div", { className: "eteg-relative eteg-w-full eteg-overflow-auto twp" },
    React__namespace.createElement("table", { ref: ref, className: cn("eteg-w-full eteg-caption-bottom eteg-text-sm", className), ...props }))));
TableRoot.displayName = "Table";
const TableHeader = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("thead", { ref: ref, className: cn("[&_tr]:eteg-border-b [&_tr]:eteg-border-b-table-line eteg-border-t-table-line [&_tr]:eteg-border-t-transparent", className), ...props })));
TableHeader.displayName = "TableHeader";
const TableBody = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("tbody", { ref: ref, className: cn("[&_tr:first-child]:eteg-border-0", className), ...props })));
TableBody.displayName = "TableBody";
const TableFooter = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("tfoot", { ref: ref, className: cn("eteg-border-t eteg-bg-muted/50 eteg-font-medium [&>tr]:last:eteg-border-b-0", className), ...props })));
TableFooter.displayName = "TableFooter";
const TableRow = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("tr", { ref: ref, className: cn("eteg-transition-colors data-[state=selected]:eteg-bg-muted eteg-border-t-table-line eteg-border-t", className), ...props })));
TableRow.displayName = "TableRow";
const TableRowDropDown = React__namespace.forwardRef(({ className, isOpen, children, ...props }, ref) => (React__namespace.createElement(Table.Row, { className: "eteg-border-t-0" },
    React__namespace.createElement(Table.Cell, { className: "eteg-py-0", ...props },
        React__namespace.createElement("div", { "data-open": isOpen, className: cn("eteg-grid data-[open=true]:eteg-mb-4 eteg-h-0 eteg-grid-cols-1 eteg-gap-4 eteg-overflow-hidden eteg-rounded-md eteg-bg-table-dropdown eteg-px-8 eteg-py-0 eteg-transition-all data-[open=true]:eteg-h-min data-[open=true]:eteg-py-6 sm:eteg-grid-cols-2 md:eteg-grid-cols-3", className), ref: ref }, children)))));
TableRowDropDown.displayName = "TableRowDropDown";
const TableHead = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("th", { ref: ref, className: cn("eteg-py-6 eteg-space-x-4 eteg-text-left eteg-text-sm eteg-text-foreground eteg-align-middle eteg-font-semibold eteg-font-lato [&:has([role=checkbox])]:eteg-pr-0", className), ...props })));
TableHead.displayName = "TableHead";
const TableCell = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("td", { ref: ref, className: cn("eteg-py-6 eteg-text-sm eteg-font-lato eteg-text-foreground/80 [&:last-child]:eteg-pr-0 eteg-align-middle eteg-pr-4", className), ...props })));
TableCell.displayName = "TableCell";
const TableCellStatus = React__namespace.forwardRef(({ status, className, ...props }, ref) => (React__namespace.createElement("td", { ref: ref, "data-status": status, className: cn("eteg-py-6 eteg-text-sm eteg-font-lato eteg-text-foreground/80 [&:last-child]:eteg-pr-0 eteg-align-middle eteg-pr-4 eteg-text-muted-foreground data-[status=true]:eteg-text-primary", className), ...props })));
TableCellStatus.displayName = "TableCellStatus";
const TableCaption = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("caption", { ref: ref, className: cn("eteg-mt-4 eteg-text-sm eteg-text-muted-foreground", className), ...props })));
...
const Pagination$1 = ({ className, ...props }) => (React__namespace.createElement("nav", { role: "navigation", "aria-label": "pagination", className: cn("eteg-mx-auto eteg-flex eteg-w-full eteg-justify-center twp", className), ...props }));
Pagination$1.displayName = "Pagination";
const PaginationContent = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("ul", { ref: ref, className: cn("eteg-flex eteg-flex-row eteg-items-center eteg-gap-2", className), ...props })));
PaginationContent.displayName = "PaginationContent";
const PaginationItem = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("li", { ref: ref, className: cn("", className), ...props })));
PaginationItem.displayName = "PaginationItem";
const PaginationLink = ({ className, isActive, ...props }) => (React__namespace.createElement("a", { "aria-current": isActive ? "page" : undefined, "data-active": !!isActive, className: cn(buttonVariants({
...
const PaginationPrevious = ({ className, ...props }) => (React__namespace.createElement(PaginationLink, { "aria-label": "Go to previous page", className: cn("eteg-gap-1 eteg-pl-2.5", className), ...props },
    React__namespace.createElement(FiChevronLeft, { className: "h-4 w-4" })));
PaginationPrevious.displayName = "PaginationPrevious";
const PaginationNext = ({ className, ...props }) => (React__namespace.createElement(PaginationLink, { "aria-label": "Go to next page", className: cn("eteg-gap-1 eteg-pr-2.5", className), ...props },
    React__namespace.createElement(FiChevronRight, { className: "eteg-h-4 eteg-w-4" })));
PaginationNext.displayName = "PaginationNext";
const PaginationEllipsis = ({ className, ...props }) => (React__namespace.createElement("span", { "aria-hidden": true, className: cn("eteg-flex eteg-h-6 eteg-w-6 eteg-items-end eteg-justify-center eteg-text-muted-foreground", className), ...props },
    React__namespace.createElement(FiMoreHorizontal, { className: "eteg-text-sm" })));
...
function Pagination({ amountPages, changePage, page, className, }) {
    ...
    return (React.createElement(Pagination$1, { className: className },
        React.createElement(PaginationContent, null,
            React.createElement(PaginationItem, null,
                React.createElement(PaginationPrevious, { onClick: () => changePage(previousPage) })),
            page > 1 && (React.createElement(PaginationItem, null,
                React.createElement(PaginationLink, { onClick: () => changePage(1) }, "1"))),
            React.createElement(PaginationItem, null,
                React.createElement(PaginationLink, { isActive: true }, page)),
            page + 1 < amountPages && (React.createElement(PaginationItem, null,
                React.createElement(PaginationEllipsis, null))),
            page < amountPages && (React.createElement(PaginationLink, { onClick: () => changePage(lastPage) }, lastPage)),
            React.createElement(PaginationItem, null,
                React.createElement(PaginationNext, { onClick: () => changePage(nextPage) })))));
}
...
const $cc7e05a45900e73f$export$e288731fd71264f0 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends$1({}, valueProps, {
...
const $cc7e05a45900e73f$export$b2af6c9944296213 = (props)=>{
    return /*#__PURE__*/ React.createElement($f1701beae083dbae$export$602eac185826482c, _extends$1({
        asChild: true
    }, props));
};
/* -------------------------------------------------------------------------------------------------
...
const $cc7e05a45900e73f$export$c973a4b3cb86a03d = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement($cc7e05a45900e73f$var$SelectContentImpl, _extends$1({}, props, {
        ref: forwardedRef
    }));
});
/* -------------------------------------------------------------------------------------------------
...
const $cc7e05a45900e73f$var$SelectContentImpl = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    }, /*#__PURE__*/ React.createElement(SelectPosition, _extends$1({
        role: "listbox",
...
const $cc7e05a45900e73f$var$SelectItemAlignedPosition = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    }, /*#__PURE__*/ React.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends$1({}, popperProps, {
        ref: composedRefs,
        style: {
...
const $cc7e05a45900e73f$var$SelectPopperPosition = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    const popperScope = $cc7e05a45900e73f$var$usePopperScope(__scopeSelect);
    return /*#__PURE__*/ React.createElement($cf1ac5d9fe0e8206$export$7c6e2c02157bb7d2, _extends$1({}, popperScope, popperProps, {
        ref: forwardedRef,
        align: align,
        collisionPadding: collisionPadding,
        style: {
...
const $cc7e05a45900e73f$export$3572fb0fb821ff49 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends$1({
...
const $cc7e05a45900e73f$export$d8117927658af6d7 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return canScrollUp1 ? /*#__PURE__*/ React.createElement($cc7e05a45900e73f$var$SelectScrollButtonImpl, _extends$1({}, props, {
        ref: composedRefs,
        onAutoScroll: ()=>{
...
const $cc7e05a45900e73f$export$ff951e476c12189 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return canScrollDown1 ? /*#__PURE__*/ React.createElement($cc7e05a45900e73f$var$SelectScrollButtonImpl, _extends$1({}, props, {
        ref: composedRefs,
        onAutoScroll: ()=>{
            const { viewport: viewport , selectedItem: selectedItem  } = contentContext;
            if (viewport && selectedItem) viewport.scrollTop = viewport.scrollTop + selectedItem.offsetHeight;
...
const $cc7e05a45900e73f$var$BubbleSelect = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
   ...
   */ return /*#__PURE__*/ React.createElement($ea1ef594cf570d83$export$439d29a4e110a164, {
        asChild: true
    }, /*#__PURE__*/ React.createElement("select", _extends$1({}, selectProps, {
        ref: composedRefs,
        defaultValue: value
    })));
});
...
function Skeleton({ className, ...props }) {
    return (React.createElement("div", { className: cn("eteg-animate-pulse eteg-rounded-md eteg-bg-input/30 eteg-h-4", className), ...props }));
}
...
const SelectContent = React__namespace.forwardRef(({ className, children, position = "popper", ...props }, ref) => (React__namespace.createElement($cc7e05a45900e73f$export$602eac185826482c, null,
    React__namespace.createElement($cc7e05a45900e73f$export$7c6e2c02157bb7d2, { ref: ref, className: cn("eteg-relative eteg-z-50 eteg-max-h-96 eteg-min-w-[8rem] eteg-overflow-hidden eteg-rounded-md eteg-border eteg-border-input eteg-bg-popover eteg-text-popover-foreground eteg-shadow-md data-[state=open]:eteg-animate-in data-[state=closed]:eteg-animate-out data-[state=closed]:eteg-fade-out-0 data-[state=open]:eteg-fade-in-0 data-[state=closed]:eteg-zoom-out-95 data-[state=open]:eteg-zoom-in-95 data-[side=bottom]:eteg-slide-in-from-top-2 data-[side=left]:eteg-slide-in-from-right-2 data-[side=right]:eteg-slide-in-from-left-2 data-[side=top]:eteg-slide-in-from-bottom-2 twp", position === "popper" &&
        ...
        React__namespace.createElement($cc7e05a45900e73f$export$d5c6c08dc2d3ca7, { className: cn("eteg-p-1", position === "popper" &&
...
const SelectLabel = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($cc7e05a45900e73f$export$b04be29aa201d4f5, { ref: ref, className: cn("eteg-py-1.5 eteg-pl-8 eteg-pr-2 eteg-text-sm eteg-font-semibold", className), ...props })));
SelectLabel.displayName = $cc7e05a45900e73f$export$b04be29aa201d4f5.displayName;
const SelectItem = React__namespace.forwardRef(({ className, children, selected, ...props }, ref) => (React__namespace.createElement($cc7e05a45900e73f$export$6d08773d2e66f8f2, { ref: ref, "data-selected": !!selected, className: cn("eteg-relative eteg-flex eteg-w-full eteg-cursor-default eteg-select-none eteg-items-center eteg-rounded-sm eteg-h-12 eteg-px-2 eteg-text-sm eteg-outline-none focus:eteg-bg-accent focus:eteg-text-accent-foreground data-[disabled]:eteg-pointer-events-none data-[disabled]:eteg-opacity-50 data-[selected=true]:eteg-text-accent-foreground", className), ...props },
...
const SelectSearchItem = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("div", { className: "eteg-h-12" },
    React__namespace.createElement(InputText, { ref: ref, inputClassName: cn("eteg-border-x-transparent eteg-border-t-transparent eteg-h-auto eteg-rounded-none eteg-py-3 eteg-text-sm", className), icon: FiSearch, ...props }))));
SelectSearchItem.displayName = $cc7e05a45900e73f$export$6d08773d2e66f8f2.displayName;
const SelectSkeletonItem = () => (React__namespace.createElement("div", { className: "eteg-relative eteg-flex eteg-items-center eteg-w-full eteg-rounded-sm eteg-h-12 eteg-px-2 eteg-outline-none" },
    React__namespace.createElement(Skeleton, { className: "eteg-h-5 eteg-w-full" })));
SelectSkeletonItem.displayName = $cc7e05a45900e73f$export$6d08773d2e66f8f2.displayName;
const SelectSeparator = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($cc7e05a45900e73f$export$1ff3c3f08ae963c0, { ref: ref, className: cn("eteg--mx-1 eteg-my-1 eteg-h-px eteg-bg-muted", className), ...props })));
...
function SelectRoot({ className, children, disabled, error, label, onValueChange, placeholder, required, value, }) {
    return (React.createElement("div", { className: cn("eteg-relative twp", className) },
        label && (React.createElement(Label, { "data-error": !!error, className: "eteg-block eteg-mb-3 peer", "aria-required": !!required }, label)),
        React.createElement(Select$1.Root, { required: required, disabled: disabled, onValueChange: onValueChange, value: value },
            React.createElement(Select$1.Trigger, { "data-error": !!error, className: "data-[error=true]:eteg-border-destructive" },
                React.createElement(Select$1.Value, { placeholder: placeholder })),
            React.createElement(Select$1.Content, null, children)),
        error && (React.createElement("span", { className: "eteg-absolute -eteg-bottom-[18px] eteg-text-xs eteg-text-destructive" }, error))));
}
const Select = {
    Root: SelectRoot,
...
const PopOverContent = ({ children, width }) => {
    ...
    return React__namespace.createElement("div", { className: "eteg-grid eteg-w-96" }, children);
};
function ComboboxRoot({ children, ...props }) {
    ...
    return (React__namespace.createElement("div", { className: "twp" },
        React__namespace.createElement(Popover.Root, { open: open, onOpenChange: setOpen },
            React__namespace.createElement(Popover.Trigger, { asChild: true, onClick: (e) => e.preventDefault() },
                React__namespace.createElement("div", { className: "eteg-relative eteg-border eteg-border-input eteg-rounded-md eteg-overflow-hidden", ref: divRef },
                    React__namespace.createElement(InputText, { icon: FiSearch, inputClassName: "eteg-border-none", onKeyDown: (e) => {
                            setValue(e.currentTarget.value);
                            if (e.key === "Enter")
                                openPopover(e.currentTarget.value);
                        }, ...props }),
                    React__namespace.createElement(Button, { className: "eteg-absolute eteg-right-0 eteg-top-0 eteg-rounded-none eteg-w-32", onClick: () => openPopover(value) }, "Buscar"))),
            React__namespace.createElement(Popover.Content, { className: "p-0 popover eteg-box-border", id: "popover", onOpenAutoFocus: (e) => e.preventDefault() },
                React__namespace.createElement(PopOverContent, { width: width }, children)))));
}
const ComboboxItem = React__namespace.forwardRef(({ className, ...props }, ref) => {
    return (React__namespace.createElement(Button, { variant: "ghost", className: cn("eteg-text-left eteg-block eteg-text-foreground/60", className), ...props, ref: ref }));
});
...
const Separator = React__namespace.forwardRef(({ className, orientation = "horizontal", decorative = true, ...props }, ref) => (React__namespace.createElement($89eedd556c436f6a$export$be92b6f5f03c0fe9, { ref: ref, decorative: decorative, orientation: orientation, className: cn("eteg-shrink-0 eteg-bg-table-line twp", orientation === "horizontal"
...
const $5d3850c4d0b4e6c7$export$bd1d06c79be19e17 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return context.modal ? /*#__PURE__*/ React.createElement($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
        present: forceMount || context.open
    }, /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$var$DialogOverlayImpl, _extends$1({}, overlayProps, {
        ref: forwardedRef
    }))) : null;
});
const $5d3850c4d0b4e6c7$var$DialogOverlayImpl = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    React.createElement(ReactRemoveScroll, {
        as: $5e63c961fc1ce211$export$8c6ed5c666ac1360,
        allowPinchZoom: true,
        shards: [
            context.contentRef
...
const $5d3850c4d0b4e6c7$export$b6d9565de1e068cf = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
        present: forceMount || context.open
    }, context.modal ? /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$var$DialogContentModal, _extends$1({}, contentProps, {
        ref: forwardedRef
    })) : /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$var$DialogContentNonModal, _extends$1({}, contentProps, {
        ref: forwardedRef
    })));
});
...
/* -----------------------------------------------------------------------------------------------*/ const $5d3850c4d0b4e6c7$var$DialogContentModal = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$var$DialogContentImpl, _extends$1({}, props, {
...
/* -----------------------------------------------------------------------------------------------*/ const $5d3850c4d0b4e6c7$var$DialogContentImpl = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement($d3863c46a17e8a28$export$20e40289641fbbb6, {
        ...
        onMountAutoFocus: onOpenAutoFocus,
        onUnmountAutoFocus: onCloseAutoFocus
    }, /*#__PURE__*/ React.createElement($5cb92bef7577960e$export$177fb62ff3ec1f22, _extends$1({
        role: "dialog",
        id: context.contentId,
...
const $5d3850c4d0b4e6c7$export$16f7638e4a34b909 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.h2, _extends$1({
        id: context.titleId
    }, titleProps, {
        ref: forwardedRef
    }));
...
const $5d3850c4d0b4e6c7$export$94e94c2ec2c954d5 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.p, _extends$1({
...
const DialogContent = React__namespace.forwardRef(({ className, children, ...props }, ref) => (React__namespace.createElement(DialogPortal, null,
    ...
    React__namespace.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, { ref: ref, className: cn("eteg-fixed eteg-left-[50%] eteg-top-[50%] eteg-z-50 eteg-grid eteg-w-full eteg-max-w-lg eteg-translate-x-[-50%] eteg-translate-y-[-50%] eteg-gap-4 eteg-border eteg-bg-background eteg-px-6 eteg-pt-10 eteg-pb-8 eteg-shadow-lg eteg-duration-200 data-[state=open]:eteg-animate-in data-[state=closed]:eteg-animate-out data-[state=closed]:eteg-fade-out-0 data-[state=open]:eteg-fade-in-0 data-[state=closed]:eteg-zoom-out-95 data-[state=open]:eteg-zoom-in-95 data-[state=closed]:eteg-slide-out-to-left-1/2 data-[state=closed]:eteg-slide-out-to-top-[48%] data-[state=open]:eteg-slide-in-from-left-1/2 data-[state=open]:eteg-slide-in-from-top-[48%] sm:eteg-rounded-lg twp", className), ...props },
        children,
        React__namespace.createElement($5d3850c4d0b4e6c7$export$f39c2d165cd861fe, { className: "eteg-absolute eteg-right-4 eteg-top-4 eteg-rounded-sm eteg-ring-offset-background focus:eteg-outline-none disabled:eteg-pointer-events-none data-[state=open]:eteg-bg-accent data-[state=open]:eteg-text-muted-foreground hover:eteg-text-destructive twp" },
            React__namespace.createElement(FiX, { size: 24 }),
            React__namespace.createElement("span", { className: "eteg-sr-only" }, "Close"))))));
DialogContent.displayName = $5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2.displayName;
const DialogHeader = ({ className, ...props }) => (React__namespace.createElement("div", { className: cn("eteg-flex eteg-flex-col eteg-space-y-1.5 eteg-text-center sm:eteg-text-left twp", className), ...props }));
DialogHeader.displayName = "DialogHeader";
const DialogFooter = ({ className, ...props }) => (React__namespace.createElement("div", { className: cn("eteg-flex eteg-flex-col-reverse sm:eteg-flex-row sm:eteg-justify-end sm:eteg-space-x-4 twp", className), ...props }));
DialogFooter.displayName = "DialogFooter";
const DialogTitle = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($5d3850c4d0b4e6c7$export$f99233281efd08a0, { ref: ref, className: cn("eteg-text-2xl sm:eteg-text-3xl eteg-font-semibold eteg-leading-none eteg-tracking-tight eteg-text-foreground eteg-max-w-[95%]", className), ...props })));
DialogTitle.displayName = $5d3850c4d0b4e6c7$export$f99233281efd08a0.displayName;
const DialogDescription = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($5d3850c4d0b4e6c7$export$393edc798c47379d, { ref: ref, className: cn("eteg-text-base sm:eteg-text-lg eteg-text-foreground/55 eteg-text-left", className), ...props })));
...
const $905f4ae918aab1aa$export$de466dd8317b0b75 = (props)=>{
    ...
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9, _extends$1({}, dialogScope, alertDialogProps, {
        modal: true
    }));
};
const $905f4ae918aab1aa$export$6edd7a623ef0f40b = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    const dialogScope = $905f4ae918aab1aa$var$useDialogScope(__scopeAlertDialog);
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$41fb9f06171c75f4, _extends$1({}, dialogScope, triggerProps, {
        ref: forwardedRef
    }));
});
const $905f4ae918aab1aa$export$660f2bfdb986706c = (props)=>{
    ...
    const dialogScope = $905f4ae918aab1aa$var$useDialogScope(__scopeAlertDialog);
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$602eac185826482c, _extends$1({}, dialogScope, portalProps));
};
const $905f4ae918aab1aa$export$a707a4895ce23256 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    const dialogScope = $905f4ae918aab1aa$var$useDialogScope(__scopeAlertDialog);
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$c6fdb837b070b4ff, _extends$1({}, dialogScope, overlayProps, {
        ref: forwardedRef
    }));
});
/* -------------------------------------------------------------------------------------------------
...
const $905f4ae918aab1aa$export$94e6af45f0af4efd = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$69b62a49393917d6, {
        ...
        cancelRef: cancelRef
    }, /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, _extends$1({
        role: "alertdialog"
...
const $905f4ae918aab1aa$export$225e0da62d314b7 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    const dialogScope = $905f4ae918aab1aa$var$useDialogScope(__scopeAlertDialog);
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$f99233281efd08a0, _extends$1({}, dialogScope, titleProps, {
        ref: forwardedRef
    }));
});
const $905f4ae918aab1aa$export$a23b55cde55ad9a5 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    const dialogScope = $905f4ae918aab1aa$var$useDialogScope(__scopeAlertDialog);
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$393edc798c47379d, _extends$1({}, dialogScope, descriptionProps, {
        ref: forwardedRef
    }));
});
const $905f4ae918aab1aa$export$b454f818c58ee85d = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    const dialogScope = $905f4ae918aab1aa$var$useDialogScope(__scopeAlertDialog);
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$f39c2d165cd861fe, _extends$1({}, dialogScope, actionProps, {
        ref: forwardedRef
    }));
});
/* -------------------------------------------------------------------------------------------------
...
const $905f4ae918aab1aa$export$2f67a923571aaea0 = /*#__PURE__*/ React.forwardRef((props, forwardedRef)=>{
    ...
    return /*#__PURE__*/ React.createElement($5d3850c4d0b4e6c7$export$f39c2d165cd861fe, _extends$1({}, dialogScope, cancelProps, {
        ref: ref
    }));
});
...
const AlertDialogOverlay = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($905f4ae918aab1aa$export$c6fdb837b070b4ff, { className: cn("eteg-fixed eteg-inset-0 eteg-z-50 eteg-bg-black/80 eteg- data-[state=open]:eteg-animate-in data-[state=closed]:eteg-animate-out data-[state=closed]:eteg-fade-out-0 data-[state=open]:eteg-fade-in-0", className), ...props, ref: ref })));
AlertDialogOverlay.displayName = $905f4ae918aab1aa$export$c6fdb837b070b4ff.displayName;
const AlertDialogContent = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement(AlertDialogPortal, null,
    React__namespace.createElement(AlertDialogOverlay, null),
    React__namespace.createElement($905f4ae918aab1aa$export$7c6e2c02157bb7d2, { ref: ref, className: cn("eteg-fixed eteg-left-[50%] eteg-top-[50%] eteg-z-50 eteg-grid eteg-w-full eteg-max-w-lg eteg-translate-x-[-50%] eteg-translate-y-[-50%] eteg-gap-4 eteg-border eteg-bg-background eteg-p-6 eteg-shadow-lg eteg-duration-200 data-[state=open]:eteg-animate-in data-[state=closed]:eteg-animate-out data-[state=closed]:eteg-fade-out-0 data-[state=open]:eteg-fade-in-0 data-[state=closed]:eteg-zoom-out-95 data-[state=open]:eteg-zoom-in-95 data-[state=closed]:eteg-slide-out-to-left-1/2 data-[state=closed]:eteg-slide-out-to-top-[48%] data-[state=open]:eteg-slide-in-from-left-1/2 data-[state=open]:eteg-slide-in-from-top-[48%] sm:eteg-rounded-lg twp", className), ...props }))));
AlertDialogContent.displayName = $905f4ae918aab1aa$export$7c6e2c02157bb7d2.displayName;
const AlertDialogHeader = ({ className, ...props }) => (React__namespace.createElement("div", { className: cn("eteg-flex eteg-flex-col eteg-space-y-2 eteg-text-center sm:eteg-text-left", className), ...props }));
AlertDialogHeader.displayName = "AlertDialogHeader";
const AlertDialogFooter = ({ className, ...props }) => (React__namespace.createElement("div", { className: cn("eteg-flex eteg-flex-col-reverse sm:eteg-flex-row sm:eteg-justify-end sm:eteg-space-x-4", className), ...props }));
AlertDialogFooter.displayName = "AlertDialogFooter";
const AlertDialogTitle = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($905f4ae918aab1aa$export$f99233281efd08a0, { ref: ref, className: cn("eteg-text-xl eteg-font-semibold eteg-leading-none eteg-tracking-tight eteg-text-foreground", className), ...props })));
AlertDialogTitle.displayName = $905f4ae918aab1aa$export$f99233281efd08a0.displayName;
const AlertDialogDescription = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($905f4ae918aab1aa$export$393edc798c47379d, { ref: ref, className: cn("eteg-text-sm eteg-text-muted-foreground", className), ...props })));
AlertDialogDescription.displayName =
    $905f4ae918aab1aa$export$393edc798c47379d.displayName;
const AlertDialogAction = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($905f4ae918aab1aa$export$e19cd5f9376f8cee, { ref: ref, className: cn(buttonVariants(), className), ...props })));
AlertDialogAction.displayName = $905f4ae918aab1aa$export$e19cd5f9376f8cee.displayName;
const AlertDialogCancel = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($905f4ae918aab1aa$export$848c9b7ead0df967, { ref: ref, className: cn(buttonVariants({ variant: "outline" }), "eteg-mt-2 sm:eteg-mt-0", className), ...props })));
...
const AvatarRoot = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($cddcb0b647441e34$export$be92b6f5f03c0fe9, { ref: ref, className: cn("eteg-relative eteg-flex eteg-h-10 eteg-w-10 eteg-shrink-0 eteg-overflow-hidden eteg-rounded-full twp", className), ...props })));
AvatarRoot.displayName = $cddcb0b647441e34$export$be92b6f5f03c0fe9.displayName;
const AvatarImage = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($cddcb0b647441e34$export$3e431a229df88919, { ref: ref, className: cn("eteg-aspect-square eteg-h-full eteg-w-full", className), ...props })));
AvatarImage.displayName = $cddcb0b647441e34$export$3e431a229df88919.displayName;
const AvatarFallback = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($cddcb0b647441e34$export$fb8d7f40caaeea67, { ref: ref, className: cn("eteg-flex eteg-h-full eteg-w-full eteg-items-center eteg-justify-center eteg-rounded-full eteg-bg-muted", className), ...props })));
...
function PopoverContent({ countries, onClickCountry, isOpen, onChangeSearch, value, width, }) {
    ...
    return (React.createElement("div", { className: "eteg-flex eteg-flex-col" },
        React.createElement(InputText, { icon: FiSearch, inputClassName: "eteg-rounded-b-none", onChange: (e) => onChangeSearch && onChangeSearch(e.target.value), value: value }),
        countries.map((country) => (React.createElement(Button, { variant: "ghost", key: country.pais, className: "eteg-text-foreground eteg-justify-start", size: "sm", onClick: () => onClickCountry(country) },
            React.createElement("img", { src: country.img, alt: country.pais, className: "eteg-mr-4" }),
            React.createElement("div", { className: "eteg-grid eteg-grid-cols-[30px_10px_auto] eteg-gap-4" },
                React.createElement("p", null, `+${country.ddi}`),
                React.createElement("span", null, "-"),
                React.createElement("p", { className: "eteg-truncate" }, country.pais)))))));
}
const InputPhone = React.forwardRef(({ value = "55", onChangeValue, error, label = "Telefone", ...props }, ref) => {
    ...
    return (React.createElement("div", { "data-error": !!error, className: "twp eteg-flex eteg-flex-col eteg-gap-3 eteg-relative group" },
        React.createElement(Label, { "data-error": !!error, "aria-required": props.required }, label),
        React.createElement("div", { className: "eteg-relative", ref: divRef },
            React.createElement(Popover.Root, { onOpenChange: setPopoverIsOpen, open: popoverIsOpen },
                React.createElement(Popover.Trigger, { asChild: true },
                    React.createElement(Button, { variant: "ghost", disabled: props.disabled, "data-error": !!error, className: "eteg-flex eteg-gap-1 eteg-absolute eteg-border-r eteg-rounded-none eteg-border-r-input eteg-z-10 data-[error=true]:eteg-border-r-destructive" },
                        React.createElement("img", { src: selectedCountry.img, alt: selectedCountry.pais }),
                        React.createElement(FiChevronDown, { size: 14, className: "eteg-text-foreground" }))),
                React.createElement(Popover.Content, { id: "popover", align: "start", className: "eteg-p-0" },
                    React.createElement(PopoverContent, { countries: mostrarItens, onClickCountry: (country) => onChangeInput("", country), isOpen: popoverIsOpen, onChangeSearch: (text) => setSearch(text), value: search, width: divWidth }))),
            React.createElement(InputText, { type: "tel", value: phoneMask(phoneNumber, selectedCountry), onChange: (e) => onChangeInput(e.target.value, selectedCountry), name: "Pais", inputClassName: "eteg-pl-20", ...props, ref: ref, error: error }))));
});
...
var V='[cmdk-group=""]',X='[cmdk-group-items=""]',ge='[cmdk-group-heading=""]',Y='[cmdk-item=""]',le=`${Y}:not([aria-disabled="true"])`,Q="cmdk-item-select",M="data-value",Re=(r,o,n)=>W(r,o,n),ue=React__namespace.createContext(void 0),G=()=>React__namespace.useContext(ue),de=React__namespace.createContext(void 0),Z=()=>React__namespace.useContext(de),fe=React__namespace.createContext(void 0),me=React__namespace.forwardRef((r,o)=>{let n=k(()=>{var e,s;return {search:"",value:(s=(e=r.value)!=null?e:r.defaultValue)!=null?s:"",filtered:{count:0,items:new Map,groups:new Set}}}),u=k(()=>new Set),c=k(()=>new Map),d=k(()=>new Map),f=k(()=>new Set),p=pe(r),{label:v,children:b,value:l,onValueChange:y,filter:S,shouldFilter:C,loop:L,disablePointerSelection:ee=!1,vimBindings:j=!0,...H}=r,te=React__namespace.useId(),$=React__namespace.useId(),K=React__namespace.useId(),x=React__namespace.useRef(null),g=Me();T(()=>{if(l!==void 0){let e=l.trim();n.current.value=e,h.emit();}},[l]),T(()=>{g(6,re);},[]);let h=React__namespace.useMemo(()=>({subscribe:e=>(f.current.add(e),()=>f.current.delete(e)),snapshot:()=>n.current,setState:(e,s,i)=>{var a,m,R;if(!Object.is(n.current[e],s)){if(n.current[e]=s,e==="search")z(),q(),g(1,U);else if(e==="value"&&(i||g(5,re),((a=p.current)==null?void 0:a.value)!==void 0)){let E=s!=null?s:"";(R=(m=p.current).onValueChange)==null||R.call(m,E);return}h.emit();}},emit:()=>{f.current.forEach(e=>e());}}),[]),B=React__namespace.useMemo(()=>({value:(e,s,i)=>{var a;s!==((a=d.current.get(e))==null?void 0:a.value)&&(d.current.set(e,{value:s,keywords:i}),n.current.filtered.items.set(e,ne(s,i)),g(2,()=>{q(),h.emit();}));},item:(e,s)=>(u.current.add(e),s&&(c.current.has(s)?c.current.get(s).add(e):c.current.set(s,new Set([e]))),g(3,()=>{z(),q(),n.current.value||U(),h.emit();}),()=>{d.current.delete(e),u.current.delete(e),n.current.filtered.items.delete(e);let i=O();g(4,()=>{z(),(i==null?void 0:i.getAttribute("id"))===e&&U(),h.emit();});}),group:e=>(c.current.has(e)||c.current.set(e,new Set),()=>{d.current.delete(e),c.current.delete(e);}),filter:()=>p.current.shouldFilter,label:v||r["aria-label"],disablePointerSelection:ee,listId:te,inputId:K,labelId:$,listInnerRef:x}),[]);function ne(e,s){var a,m;let i=(m=(a=p.current)==null?void 0:a.filter)!=null?m:Re;return e?i(e,n.current.search,s):0}function q(){if(!n.current.search||p.current.shouldFilter===!1)return;let e=n.current.filtered.items,s=[];n.current.filtered.groups.forEach(a=>{let m=c.current.get(a),R=0;m.forEach(E=>{let P=e.get(E);R=Math.max(P,R);}),s.push([a,R]);});let i=x.current;A().sort((a,m)=>{var P,_;let R=a.getAttribute("id"),E=m.getAttribute("id");return ((P=e.get(E))!=null?P:0)-((_=e.get(R))!=null?_:0)}).forEach(a=>{let m=a.closest(X);m?m.appendChild(a.parentElement===m?a:a.closest(`${X} > *`)):i.appendChild(a.parentElement===i?a:a.closest(`${X} > *`));}),s.sort((a,m)=>m[1]-a[1]).forEach(a=>{let m=x.current.querySelector(`${V}[${M}="${encodeURIComponent(a[0])}"]`);m==null||m.parentElement.appendChild(m);});}function U(){let e=A().find(i=>i.getAttribute("aria-disabled")!=="true"),s=e==null?void 0:e.getAttribute(M);h.setState("value",s||void 0);}function z(){var s,i,a,m;if(!n.current.search||p.current.shouldFilter===!1){n.current.filtered.count=u.current.size;return}n.current.filtered.groups=new Set;let e=0;for(let R of u.current){let E=(i=(s=d.current.get(R))==null?void 0:s.value)!=null?i:"",P=(m=(a=d.current.get(R))==null?void 0:a.keywords)!=null?m:[],_=ne(E,P);n.current.filtered.items.set(R,_),_>0&&e++;}for(let[R,E]of c.current)for(let P of E)if(n.current.filtered.items.get(P)>0){n.current.filtered.groups.add(R);break}n.current.filtered.count=e;}function re(){var s,i,a;let e=O();e&&(((s=e.parentElement)==null?void 0:s.firstChild)===e&&((a=(i=e.closest(V))==null?void 0:i.querySelector(ge))==null||a.scrollIntoView({block:"nearest"})),e.scrollIntoView({block:"nearest"}));}function O(){var e;return (e=x.current)==null?void 0:e.querySelector(`${Y}[aria-selected="true"]`)}function A(){var e;return Array.from((e=x.current)==null?void 0:e.querySelectorAll(le))}function W(e){let i=A()[e];i&&h.setState("value",i.getAttribute(M));}function J(e){var R;let s=O(),i=A(),a=i.findIndex(E=>E===s),m=i[a+e];(R=p.current)!=null&&R.loop&&(m=a+e<0?i[i.length-1]:a+e===i.length?i[0]:i[a+e]),m&&h.setState("value",m.getAttribute(M));}function oe(e){let s=O(),i=s==null?void 0:s.closest(V),a;for(;i&&!a;)i=e>0?we(i,V):Ie(i,V),a=i==null?void 0:i.querySelector(le);a?h.setState("value",a.getAttribute(M)):J(e);}let ie=()=>W(A().length-1),ae=e=>{e.preventDefault(),e.metaKey?ie():e.altKey?oe(1):J(1);},se=e=>{e.preventDefault(),e.metaKey?W(0):e.altKey?oe(-1):J(-1);};return React__namespace.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div,{ref:o,tabIndex:-1,...H,"cmdk-root":"",onKeyDown:e=>{var s;if((s=H.onKeyDown)==null||s.call(H,e),!e.defaultPrevented)switch(e.key){case"n":case"j":{j&&e.ctrlKey&&ae(e);break}case"ArrowDown":{ae(e);break}case"p":case"k":{j&&e.ctrlKey&&se(e);break}case"ArrowUp":{se(e);break}case"Home":{e.preventDefault(),W(0);break}case"End":{e.preventDefault(),ie();break}case"Enter":if(!e.nativeEvent.isComposing&&e.keyCode!==229){e.preventDefault();let i=O();if(i){let a=new Event(Q);i.dispatchEvent(a);}}}}},React__namespace.createElement("label",{"cmdk-label":"",htmlFor:B.inputId,id:B.labelId,style:De},v),F(r,e=>React__namespace.createElement(de.Provider,{value:h},React__namespace.createElement(ue.Provider,{value:B},e))))}),be=React__namespace.forwardRef((r,o)=>{var K,x;let n=React__namespace.useId(),u=React__namespace.useRef(null),c=React__namespace.useContext(fe),d=G(),f=pe(r),p=(x=(K=f.current)==null?void 0:K.forceMount)!=null?x:c==null?void 0:c.forceMount;T(()=>{if(!p)return d.item(n,c==null?void 0:c.id)},[p]);let v=ve(n,u,[r.value,r.children,u],r.keywords),b=Z(),l=D(g=>g.value&&g.value===v.current),y=D(g=>p||d.filter()===!1?!0:g.search?g.filtered.items.get(n)>0:!0);React__namespace.useEffect(()=>{let g=u.current;if(!(!g||r.disabled))return g.addEventListener(Q,S),()=>g.removeEventListener(Q,S)},[y,r.onSelect,r.disabled]);function S(){var g,h;C(),(h=(g=f.current).onSelect)==null||h.call(g,v.current);}function C(){b.setState("value",v.current,!0);}if(!y)return null;let{disabled:L,value:ee,onSelect:j,forceMount:H,keywords:te,...$}=r;return React__namespace.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div,{ref:N([u,o]),...$,id:n,"cmdk-item":"",role:"option","aria-disabled":!!L,"aria-selected":!!l,"data-disabled":!!L,"data-selected":!!l,onPointerMove:L||d.disablePointerSelection?void 0:C,onClick:L?void 0:S},r.children)}),he=React__namespace.forwardRef((r,o)=>{let{heading:n,children:u,forceMount:c,...d}=r,f=React__namespace.useId(),p=React__namespace.useRef(null),v=React__namespace.useRef(null),b=React__namespace.useId(),l=G(),y=D(C=>c||l.filter()===!1?!0:C.search?C.filtered.groups.has(f):!0);T(()=>l.group(f),[]),ve(f,p,[r.value,r.heading,v]);let S=React__namespace.useMemo(()=>({id:f,forceMount:c}),[c]);return React__namespace.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div,{ref:N([p,o]),...d,"cmdk-group":"",role:"presentation",hidden:y?void 0:!0},n&&React__namespace.createElement("div",{ref:v,"cmdk-group-heading":"","aria-hidden":!0,id:b},n),F(r,C=>React__namespace.createElement("div",{"cmdk-group-items":"",role:"group","aria-labelledby":n?b:void 0},React__namespace.createElement(fe.Provider,{value:S},C))))}),ye=React__namespace.forwardRef((r,o)=>{let{alwaysRender:n,...u}=r,c=React__namespace.useRef(null),d=D(f=>!f.search);return !n&&!d?null:React__namespace.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div,{ref:N([c,o]),...u,"cmdk-separator":"",role:"separator"})}),Ee=React__namespace.forwardRef((r,o)=>{let{onValueChange:n,...u}=r,c=r.value!=null,d=Z(),f=D(l=>l.search),p=D(l=>l.value),v=G(),b=React__namespace.useMemo(()=>{var y;let l=(y=v.listInnerRef.current)==null?void 0:y.querySelector(`${Y}[${M}="${encodeURIComponent(p)}"]`);return l==null?void 0:l.getAttribute("id")},[]);return React__namespace.useEffect(()=>{r.value!=null&&d.setState("search",r.value);},[r.value]),React__namespace.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.input,{ref:o,...u,"cmdk-input":"",autoComplete:"off",autoCorrect:"off",spellCheck:!1,"aria-autocomplete":"list",role:"combobox","aria-expanded":!0,"aria-controls":v.listId,"aria-labelledby":v.labelId,"aria-activedescendant":b,id:v.inputId,type:"text",value:c?r.value:f,onChange:l=>{c||d.setState("search",l.target.value),n==null||n(l.target.value);}})}),Se=React__namespace.forwardRef((r,o)=>{let{children:n,label:u="Suggestions",...c}=r,d=React__namespace.useRef(null),f=React__namespace.useRef(null),p=G();return React__namespace.useEffect(()=>{if(f.current&&d.current){let v=f.current,b=d.current,l,y=new ResizeObserver(()=>{l=requestAnimationFrame(()=>{let S=v.offsetHeight;b.style.setProperty("--cmdk-list-height",S.toFixed(1)+"px");});});return y.observe(v),()=>{cancelAnimationFrame(l),y.unobserve(v);}}},[]),React__namespace.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div,{ref:N([d,o]),...c,"cmdk-list":"",role:"listbox","aria-label":u,id:p.listId},F(r,v=>React__namespace.createElement("div",{ref:N([f,p.listInnerRef]),"cmdk-list-sizer":""},v)))}),Ce=React__namespace.forwardRef((r,o)=>{let{open:n,onOpenChange:u,overlayClassName:c,contentClassName:d,container:f,...p}=r;return React__namespace.createElement($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9,{open:n,onOpenChange:u},React__namespace.createElement($5d3850c4d0b4e6c7$export$602eac185826482c,{container:f},React__namespace.createElement($5d3850c4d0b4e6c7$export$c6fdb837b070b4ff,{"cmdk-overlay":"",className:c}),React__namespace.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2,{"aria-label":r.label,"cmdk-dialog":"",className:d},React__namespace.createElement(me,{ref:o,...p}))))}),xe=React__namespace.forwardRef((r,o)=>D(u=>u.filtered.count===0)?React__namespace.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div,{ref:o,...r,"cmdk-empty":"",role:"presentation"}):null),Pe=React__namespace.forwardRef((r,o)=>{let{progress:n,children:u,label:c="Loading...",...d}=r;return React__namespace.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div,{ref:o,...d,"cmdk-loading":"",role:"progressbar","aria-valuenow":n,"aria-valuemin":0,"aria-valuemax":100,"aria-label":c},F(r,f=>React__namespace.createElement("div",{"aria-hidden":!0},f)))}),He=Object.assign(me,{List:Se,Item:be,Input:Ee,Group:he,Separator:ye,Dialog:Ce,Empty:xe,Loading:Pe});function we(r,o){let n=r.nextElementSibling;for(;n;){if(n.matches(o))return n;n=n.nextElementSibling;}}function Ie(r,o){let n=r.previousElementSibling;for(;n;){if(n.matches(o))return n;n=n.previousElementSibling;}}function pe(r){let o=React__namespace.useRef(r);return T(()=>{o.current=r;}),o}var T=typeof window=="undefined"?React__namespace.useEffect:React__namespace.useLayoutEffect;function k(r){let o=React__namespace.useRef();return o.current===void 0&&(o.current=r()),o}function N(r){return o=>{r.forEach(n=>{typeof n=="function"?n(o):n!=null&&(n.current=o);});}}function D(r){let o=Z(),n=()=>r(o.snapshot());return React__namespace.useSyncExternalStore(o.subscribe,n,n)}function ve(r,o,n,u=[]){let c=React__namespace.useRef(),d=G();return T(()=>{var v;let f=(()=>{var b;for(let l of n){if(typeof l=="string")return l.trim();if(typeof l=="object"&&"current"in l)return l.current?(b=l.current.textContent)==null?void 0:b.trim():c.current}})(),p=u.map(b=>b.trim());d.value(r,f,p),(v=o.current)==null||v.setAttribute(M,f),c.current=f;}),c}var Me=()=>{let[r,o]=React__namespace.useState(),n=k(()=>new Map);return T(()=>{n.current.forEach(u=>u()),n.current=new Map;},[r]),(u,c)=>{n.current.set(u,c),o({});}};function Te(r){let o=r.type;return typeof o=="function"?o(r.props):"render"in o?o.render(r.props):r}function F({asChild:r,children:o},n){return r&&React__namespace.isValidElement(o)?React__namespace.cloneElement(Te(o),{ref:o.ref},n(o.props.children)):n(o)}var De={position:"absolute",width:"1px",height:"1px",padding:"0",margin:"-1px",overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",borderWidth:"0"};

const CommandRoot = React.forwardRef(({ className, ...props }, ref) => (React.createElement(He, { ref: ref, className: cn("eteg-flex eteg-h-full eteg-w-full eteg-flex-col eteg-overflow-hidden eteg-rounded-md eteg-bg-popover eteg-text-popover-foreground twp", className), ...props })));
CommandRoot.displayName = He.displayName;
const CommandDialog = ({ children, ...props }) => {
    return (React.createElement(Dialog.Root, { ...props },
        React.createElement(Dialog.Content, { className: "eteg-overflow-hidden eteg-p-0 eteg-shadow-lg" },
            React.createElement(CommandRoot, { className: "[&_[cmdk-group-heading]]:eteg-px-2 [&_[cmdk-group-heading]]:eteg-font-medium [&_[cmdk-group-heading]]:eteg-text-muted-foreground [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:eteg-pt-0 [&_[cmdk-group]]:eteg-px-2 [&_[cmdk-input-wrapper]_svg]:eteg-h-5 [&_[cmdk-input-wrapper]_svg]:eteg-w-5 [&_[cmdk-input]]:eteg-h-12 [&_[cmdk-item]]:eteg-px-2 [&_[cmdk-item]]:eteg-py-3 [&_[cmdk-item]_svg]:eteg-h-5 [&_[cmdk-item]_svg]:eteg-w-5" }, children))));
};
const CommandInput = React.forwardRef(({ className, ...props }, ref) => (React.createElement("div", { className: "eteg-flex eteg-items-center eteg-border-b eteg-px-3", "cmdk-input-wrapper": "" },
    React.createElement(FiSearch, { className: "eteg-mr-2 eteg-h-4 eteg-w-4 eteg-shrink-0 eteg-opacity-50" }),
    React.createElement(He.Input, { ref: ref, className: cn("eteg-flex eteg-h-11 eteg-w-full eteg-rounded-md eteg-bg-transparent eteg-py-3 eteg-text-sm eteg-outline-none placeholder:eteg-text-muted-foreground disabled:eteg-cursor-not-allowed disabled:eteg-opacity-50", className), ...props }))));
CommandInput.displayName = He.Input.displayName;
const CommandList = React.forwardRef(({ className, ...props }, ref) => (React.createElement(He.List, { ref: ref, className: cn("eteg-max-h-[300px] eteg-overflow-y-auto eteg-overflow-x-hidden", className), ...props })));
CommandList.displayName = He.List.displayName;
const CommandEmpty = React.forwardRef((props, ref) => (React.createElement(He.Empty, { ref: ref, className: "eteg-py-6 eteg-text-center eteg-text-sm", ...props })));
CommandEmpty.displayName = He.Empty.displayName;
const CommandGroup = React.forwardRef(({ className, ...props }, ref) => (React.createElement(He.Group, { ref: ref, className: cn("eteg-overflow-hidden eteg-p-1 eteg-text-foreground [&_[cmdk-group-heading]]:eteg-px-2 [&_[cmdk-group-heading]]:eteg-py-1.5 [&_[cmdk-group-heading]]:eteg-text-xs [&_[cmdk-group-heading]]:eteg-font-medium [&_[cmdk-group-heading]]:eteg-text-muted-foreground", className), ...props })));
CommandGroup.displayName = He.Group.displayName;
const CommandSeparator = React.forwardRef(({ className, ...props }, ref) => (React.createElement(He.Separator, { ref: ref, className: cn("eteg--mx-1 eteg-h-px eteg-bg-border", className), ...props })));
CommandSeparator.displayName = He.Separator.displayName;
const CommandItem = React.forwardRef(({ className, ...props }, ref) => (React.createElement(He.Item, { ref: ref, className: cn("eteg-relative eteg-flex eteg-cursor-default eteg-select-none eteg-items-center eteg-rounded-sm eteg-px-2 eteg-py-1.5 eteg-text-sm eteg-outline-none aria-selected:eteg-bg-accent aria-selected:eteg-text-accent-foreground data-[disabled=true]:eteg-pointer-events-none data-[disabled=true]:eteg-opacity-50", className), ...props })));
CommandItem.displayName = He.Item.displayName;
const CommandShortcut = ({ className, ...props }) => {
    return (React.createElement("span", { className: cn("eteg-ml-auto eteg-text-xs eteg-tracking-widest eteg-text-muted-foreground", className), ...props }));
};
...
const SelectSearchContent = ({ buttonRef, children, emptyMessage, inputPlaceholder, onChange, onSelect, value, }) => {
    ...
    return (React.createElement(Popover.Content, { style: { width: `${width}px` }, className: "eteg-p-0 twp eteg-border-input" },
        React.createElement(Command.Root, null,
            React.createElement(InputText, { icon: FiSearch, inputClassName: "eteg-border-x-transparent eteg-rounded-none eteg-border-t-transparent", placeholder: inputPlaceholder, onChange: (event) => onChange(event.currentTarget.value), value: value }),
            React.createElement(Command.Empty, null, emptyMessage),
            React.createElement(Command.List, null,
                React.createElement(Command.Group, null, React.Children.map(children, (child, index) => (React.createElement(Command.Item, { onSelect: () => onSelect(index), className: "eteg-h-12 eteg-px-2" }, child))))))));
};
SelectSearchContent.displayName = "SelectSearchContent";
const SelectSearchSkeletonItem = () => (React.createElement(Skeleton, { className: "eteg-h-5 eteg-w-full" }));
SelectSearchSkeletonItem.displayName = "SelectSearchSkeletonItem";
function SelectSearchRoot({ children, onChange, onSelect, trigger, value, className, disabled = false, emptyMessage, error, inputPlaceholder, label, required = false, }) {
    ...
    return (React.createElement("div", { className: cn("eteg-relative twp", className) },
        ...
        React.createElement(Popover.Root, { open: open, onOpenChange: setOpen },
            React.createElement(Popover.Trigger, { asChild: true },
                React.createElement(Button, { variant: "outline", role: "combobox", "aria-expanded": open, "data-error": !!error, className: "eteg-w-full eteg-justify-between twp eteg-border-input eteg-text-secondary data-[error=true]:eteg-border-destructive", ref: buttonRef, disabled: disabled },
                    trigger,
                    React.createElement(FiChevronDown, { className: "eteg-ml-2 eteg-h-4 eteg-w-4 eteg-shrink-0 eteg-opacity-50" }))),
            React.createElement(SelectSearchContent, { buttonRef: buttonRef, value: value, onChange: onChange, onSelect: (index) => {
                    setOpen(false);
                    onSelect(index);
                }, emptyMessage: emptyMessage, inputPlaceholder: inputPlaceholder, children: children })),
        error && (React.createElement("span", { className: "eteg-absolute -eteg-bottom-[18px] eteg-text-xs eteg-text-destructive eteg-left-0" }, error))));
}
const SelectSearch = {
