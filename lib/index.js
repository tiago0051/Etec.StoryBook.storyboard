...
const TableCell = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("td", { ref: ref, className: cn("eteg-py-6 eteg-text-sm eteg-font-lato eteg-text-foreground/85 [&:last-child]:eteg-pr-0 eteg-align-middle eteg-pr-4", className), ...props })));
