...
function InputFile({ valueText, label, error, onRemove, className, icon: Icon, ...props }) {
    ...
    return (React.createElement("div", { className: "eteg-relative twp" },
        ...
        React.createElement("div", { "data-disabled": props.disabled, "data-error": !!error, className: cn("eteg-h-12 eteg-border eteg-border-input eteg-grid eteg-grid-flow-col eteg-gap-3 eteg-rounded-md eteg-px-5 eteg-disabled:cursor-not-allowed data-[disabled=true]:eteg-bg-muted data-[error=true]:eteg-border-destructive", className) },
...
const InputText = React__namespace.forwardRef(({ className, type, label, error, icon: Icon, inputClassName, ...props }, ref) => {
    return (React__namespace.createElement("div", { className: cn("eteg-relative twp", className) },
        ...
        React__namespace.createElement("div", { className: "eteg-relative eteg-flex eteg-items-center" },
            ...
            React__namespace.createElement("input", { type: type, "data-error": !!error, "data-icon": !!Icon, className: cn("eteg-flex eteg-h-12 eteg-w-full eteg-rounded-md eteg-border eteg-border-input eteg-bg-transparent eteg-px-4 eteg-text-sm placeholder:text-muted-foreground eteg-disabled:cursor-not-allowed eteg-disabled:bg-muted eteg-disabled:text-muted-foreground eteg-text-foreground data-[error=true]:eteg-border-destructive data-[icon=true]:eteg-pl-12 focus:eteg-outline-none", inputClassName), ref: ref, ...props })),
