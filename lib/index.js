    ...
    return (React.createElement(Popover.Content, { style: { width: `${width}px` }, className: "eteg-p-0 twp eteg-border-input" },
        React.createElement(Command.Root, null,
            ...
            React.createElement(Command.List, null,
                React.createElement(Command.Group, { onSelect: () => onSelect() }, children)))));
};
SelectSearchContent.displayName = "SelectSearchContent";
const SelectSearchItem = React.forwardRef(({ className, ...props }) => (React.createElement(Command.Item, { ...props, className: cn("eteg-h-12 eteg-px-2", className) })));
SelectSearchItem.displayName = "SelectSearchItem";
const SelectSearchSkeletonItem = React.forwardRef(({ className, ...props }) => (React.createElement(Command.Item, { ...props, className: cn("eteg-h-12 eteg-px-2", className) },
    React.createElement(Skeleton, { className: "eteg-h-5 eteg-w-full" }))));
SelectSearchSkeletonItem.displayName = "SelectSearchSkeletonItem";
function SelectSearchRoot({ children, onChange, trigger, value, className, disabled = false, emptyMessage, error, inputPlaceholder, label, required = false, }) {
    ...
    return (React.createElement("div", { className: cn("eteg-relative twp", className) },
        ...
        React.createElement(Popover.Root, { open: open, onOpenChange: setOpen },
            ...
            React.createElement(SelectSearchContent, { buttonRef: buttonRef, value: value, onSelect: () => {
                    setOpen(false);
                }, onChange: onChange, emptyMessage: emptyMessage, inputPlaceholder: inputPlaceholder }, children)),
