...
const Checkbox = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($e698a72e93240346$export$be92b6f5f03c0fe9, { ref: ref, className: cn("eteg-peer eteg-h-5 eteg-w-5 eteg-shrink-0 eteg-rounded-sm eteg-border eteg-border-checkbox eteg-ring-offset-background focus-visible:eteg-outline-none focus-visible:eteg-ring-2 focus-visible:eteg-ring-ring focus-visible:eteg-ring-offset-2 disabled:eteg-cursor-not-allowed disabled:eteg-opacity-50 data-[state=checked]:eteg-bg-checkbox data-[state=checked]:eteg-text-checkbox-foreground twp", className), ...props },
