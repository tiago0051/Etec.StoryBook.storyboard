...
const PopoverContent = React__namespace.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => (React__namespace.createElement($cb5cc270b50c6fcd$export$602eac185826482c, null,
...
function ComboboxRoot({ children, ...props }) {
    ...
    return (React__namespace.createElement("div", { className: "twp" },
        React__namespace.createElement(Popover, { open: open, onOpenChange: setOpen },
            React__namespace.createElement(PopoverTrigger, { asChild: true, onClick: (e) => e.preventDefault() },
            ...
            React__namespace.createElement(PopoverContent, { className: "p-0 popover eteg-box-border", id: "popover", onOpenAutoFocus: (e) => e.preventDefault() },
