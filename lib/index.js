...
const Label = React__namespace.forwardRef(({ className, children, ...props }, ref) => (React__namespace.createElement($b73a6c6685e72184$export$be92b6f5f03c0fe9, { ref: ref, className: cn(labelVariants(), className), ...props },
    children,
    React__namespace.createElement("span", { className: "eteg-text-xl eteg-font-bold eteg-text-destructive eteg-absolute eteg-hidden aria-required:eteg-inline -eteg-top-3 eteg-px-1", "aria-required": props["aria-required"] }, "*"))));
...
function InputFile({ valueText, label, error, onRemove, className, icon: Icon, ...props }) {
    ...
    return (React.createElement("div", { className: "eteg-relative twp" },
        label && (React.createElement(Label, { "data-error": !!error, htmlFor: props.name, className: "block mb-3" },
            label,
            " ",
        ...
        error && (React.createElement("span", { className: "eteg-absolute eteg--bottom-5 eteg-text-xs eteg-text-destructive" }, error))));
}
...
const InputText = React__namespace.forwardRef(({ className, type, label, error, icon: Icon, inputClassName, ...props }, ref) => {
    return (React__namespace.createElement("div", { className: cn("eteg-relative twp", className) },
        ...
        error && (React__namespace.createElement("span", { className: "eteg-absolute eteg--bottom-5 eteg-text-xs eteg-text-destructive" }, error))));
});
...
function PopoverContent({ countries, isOpen, width, onChangeSearch, value, }) {
    React.useEffect(() => {
        const element = document.getElementById("popover");
        if (width)
            element.style.width = `${width}px`;
    ...
    return (React.createElement("div", { className: "eteg-flex eteg-flex-col" },
        ...
        countries.map((country) => (React.createElement(Button, { variant: "ghost", key: country.pais, className: "eteg-text-foreground eteg-justify-start", size: "sm" },
...
const InputPhone = React.forwardRef(({ value = "55", onChangeValue, error, label = "Telefone", ...props }, ref) => {
    ...
    return (React.createElement("div", { "data-error": !!error, ref: divRef, className: "twp eteg-flex eteg-flex-col eteg-gap-3" },
        React.createElement(Label, { "aria-required": props.required }, label),
        React.createElement("div", { className: "eteg-relative" },
            React.createElement(Popover.Root, { onOpenChange: setPopoverIsOpen, open: popoverIsOpen },
                React.createElement(Popover.Trigger, { asChild: true },
                    React.createElement(Button, { variant: "ghost", disabled: props.disabled, className: "eteg-flex eteg-gap-1 eteg-absolute eteg-border-r eteg-rounded-none eteg-border-r-input eteg-z-10" },
                ...
                React.createElement(Popover.Content, { id: "popover", align: "start", className: "eteg-p-0" },
                    React.createElement(PopoverContent, { countries: mostrarItens, width: divWidth, isOpen: popoverIsOpen, onChangeSearch: (text) => setSearch(text), value: search }))),
            React.createElement(InputText, { type: "tel", value: phoneMask(phoneNumber, selectedCountry), onChange: (e) => onChangeInput(e.target.value, selectedCountry), name: "Pais", inputClassName: "eteg-pl-20", ...props, ref: ref })),
