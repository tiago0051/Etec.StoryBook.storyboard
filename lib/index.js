...
const DialogTitle = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($5d3850c4d0b4e6c7$export$f99233281efd08a0, { ref: ref, className: cn("eteg-text-xl eteg-font-semibold eteg-leading-none eteg-tracking-tight eteg-text-foreground", className), ...props })));
DialogTitle.displayName = $5d3850c4d0b4e6c7$export$f99233281efd08a0.displayName;
const DialogDescription = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement($5d3850c4d0b4e6c7$export$393edc798c47379d, { ref: ref, className: cn("eteg-text-sm eteg-text-muted-foreground", className), ...props })));
