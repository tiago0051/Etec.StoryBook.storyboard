...
function Header({ children, onBackClick, subtitle, title, }) {
    return (React.createElement("div", { className: "twp" },
        onBackClick && (React.createElement(Button, { variant: "link", size: "none", type: "button", className: "eteg-flex eteg-gap-3 eteg-text-foreground/60 eteg-hover:text-foreground eteg-mb-5", onClick: () => onBackClick() },
        ...
        React.createElement("div", { className: "eteg-flex eteg-flex-col sm:eteg-flex-row sm:eteg-justify-between sm:eteg-items-center eteg-gap-4" },
            React.createElement("div", null,
                React.createElement("h1", { className: "eteg-font-lato eteg-font-semibold eteg-text-3xl eteg-text-foreground eteg-mb-1" }, title),
                React.createElement("p", { className: "eteg-font-lato eteg-font-semibold eteg-text-base eteg-text-foreground/60" }, subtitle)),
...
const InputText = React__namespace.forwardRef(({ className, type, label, error, icon: Icon, ...props }, ref) => {
    return (React__namespace.createElement("div", { className: cn("eteg-relative twp", className) },
        ...
        React__namespace.createElement("div", { className: "eteg-relative eteg-flex eteg-items-center" },
            ...
            React__namespace.createElement("input", { type: type, "data-error": !!error, "data-icon": !!Icon, className: "eteg-flex eteg-h-12 eteg-w-full eteg-rounded-md eteg-border eteg-border-input eteg-bg-transparent eteg-px-4 eteg-text-sm placeholder:text-muted-foreground eteg-disabled:cursor-not-allowed eteg-disabled:bg-muted eteg-disabled:text-muted-foreground eteg-text-foreground data-[error=true]:eteg-border-destructive data-[icon=true]:eteg-pl-12 focus:eteg-outline-none", ref: ref, ...props })),
...
const TableHeader = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("thead", { ref: ref, className: cn("[&_tr]:eteg-border-b [&_tr]:eteg-border-b-input [&_tr]:eteg-border-t-transparent", className), ...props })));
...
const TableRow = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("tr", { ref: ref, className: cn("eteg-transition-colors data-[state=selected]:eteg-bg-muted eteg-border-t-input eteg-border-t", className), ...props })));
...
const TableCell = React__namespace.forwardRef(({ className, ...props }, ref) => (React__namespace.createElement("td", { ref: ref, className: cn("eteg-py-6 eteg-text-sm eteg-text-foreground/80 [&:last-child]:eteg-pr-0 eteg-align-middle eteg-pr-4", className), ...props })));
