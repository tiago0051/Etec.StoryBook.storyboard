...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "eteg-flex eteg-h-12 eteg-w-full eteg-items-center eteg-justify-between eteg-rounded-md eteg-border eteg-border-input eteg-bg-transparent eteg-px-3 eteg-py-2 eteg-text-sm placeholder:eteg-text-muted-foreground eteg-text-secondary focus:eteg-outline-none disabled:eteg-cursor-not-allowed disabled:eteg-bg-muted [&>span]:eteg-line-clamp-1 font-inter hover:eteg-filter-none eteg-normal-case twp",
      className
    )}
    {...props}
  >
...
const SelectSkeletonItem = () => (
  <div
    className={
      "eteg-relative eteg-flex eteg-items-center eteg-w-full eteg-rounded-sm eteg-h-12 eteg-px-2 eteg-outline-none"
    }
  >
    <Skeleton className="eteg-h-5 eteg-w-full" />
  </div>
);
SelectSkeletonItem.displayName = SelectPrimitive.Item.displayName;
